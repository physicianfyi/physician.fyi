 ...
 * This was for getting documents from MBC's document search but DCA website used in other scrapers has more info
 */

import type { ElementHandle, Page } from "puppeteer";
import puppeteer from "puppeteer";
import fs from "fs";
import { delay, downloadFile } from "../../util";
...
(async () => {
  ...
  // TODO Make new runs read existing file and only read until first existing one, which also lets us keep old ones that get taken down
