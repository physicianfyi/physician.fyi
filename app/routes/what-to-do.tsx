    ...
    <article className="p-8 prose dark:prose-invert mx-auto">
      ...
      <ul>
        ...
        <li>
          ...
          amend the contract to exlude that provision, as the FTC Consumer
          Review Fairness Act ensures consumers meaningful opportunity to
          negotiate nondisclosure terms. Also note that anything you signed
          before the procedure/incident cannot take away your right to post
          reviews about it based on the FTC Consumer Review Fairness Act, which
          says any NDA you sign prior to service is illegal and has the
          potential to invalidate the entire contract.
        </li>
        <li>
